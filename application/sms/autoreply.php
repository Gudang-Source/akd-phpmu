              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_sms_autoreply ORDER BY id_autoreply DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET['hapus'])){
                          mysqli_query(dblink(), "DELETE FROM rb_sms_autoreply where id_autoreply='".$_GET['hapus']."'");
...
<?php 
    ...
    if (isset($_POST['update'])){
        mysqli_query(dblink(), "UPDATE rb_sms_autoreply SET keyword = '".$_POST['a']."',
                                         isi_pesan = '".$_POST['b']."' where id_autoreply='".$_POST['id']."'");
      echo "<script>document.location='index.php?view=autoreply';</script>";
    }
    $edit = mysqli_query(dblink(), "SELECT * FROM rb_sms_autoreply where id_autoreply='".$_GET['id']."'");
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=autoreply' class='btn btn-default pull-right'>Cancel</a>
    ...
    if (isset($_POST['tambah'])){
        mysqli_query(dblink(), "INSERT INTO rb_sms_autoreply VALUES('','".$_POST['a']."','".$_POST['b']."','".date('Y-m-d H:i:s')."')");
        echo "<script>document.location='index.php?view=autoreply';</script>";
    }
