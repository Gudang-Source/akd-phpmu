...
<?php 
    ...
    if(!isset($_GET['id']) AND isset($_GET['jdwl'])) {
      $_GET['id'] = $_GET['jdwl'];
    }
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  ...
                  <table id='example' class='table table-bordered table-striped'>
                    ...
                    <tbody>";
                      $tampil = mysqli_query(dblink(), "SELECT * FROM rb_journal_list where kodejdwl='".$_GET['id']."' ORDER BY id_journal DESC");
                    $no = 1;
                    while($r=mysqli_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
                              <td>".$r['hari']."</td>
                              ...
                              if($_SESSION['level']!='kepala'){
                                echo "<td style='width:80px !important'><center>
                                        ...
                                        <a class='btn btn-danger btn-xs' title='Delete Data' href='index.php?view=journalkbm&act=lihat&hapus=".$r['id_journal']."&jdwl=".$_GET['id']."'><span class='glyphicon glyphicon-remove'></span></a>
                                      </center></td>";
                              }
                            echo "</tr>";
                      $no++;
                      ...
                      if (isset($_GET['hapus'])){
                        mysqli_query(dblink(), "DELETE FROM rb_journal_list where id_journal='".$_GET['hapus']."'");
    ...
    if (isset($_POST['tambah'])){
        ...
        mysqli_query(dblink(), "INSERT INTO rb_journal_list VALUES('','".$_POST['jdwl']."','".$_POST['c']."','$d','".$_POST['e']."','".$_POST['f']."','".$_POST['g']."','".date('Y-m-d H:i:s')."','".$_SESSION['id']."')");
    ...
    $jam = mysqli_num_rows(mysqli_query(dblink(), "SELECT * FROM rb_journal_list where kodejdwl='".$_GET['jdwl']."'"))+1;
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=journalkbm&act=lihat&id=".$_GET['jdwl']."' class='btn btn-default pull-right'>Cancel</a>
    ...
    if (isset($_POST['update'])){
        $d = tgl_simpan($_POST['d']);
        mysqli_query(dblink(), "UPDATE rb_journal_list SET hari = '".$_POST['c']."',
                                                tanggal = '$d',
                                                jam_ke = '".$_POST['e']."',
                                                materi = '".$_POST['f']."',
                                                keterangan = '".$_POST['g']."',
    ...
    $e = mysqli_fetch_array(mysqli_query(dblink(), "SELECT a.*, b.kode_pelajaran, b.kode_kelas FROM rb_journal_list a JOIN rb_jadwal_pelajaran b ON a.kodejdwl=b.kodejdwl where a.id_journal='".$_GET['id']."'"));
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
