                  ...
                  <?php
                    ...
                    if(isset($tampil)) {
                      while($r=mysqli_fetch_array($tampil)){
                        $total = mysqli_num_rows(mysqli_query(dblink(), "SELECT * FROM rb_elearning where kodejdwl='".$r['kodejdwl']."'"));
                        echo "<tr><td>$no</td>
              ...
              <input type='hidden' name='pelajaran' value='".$_GET['kd']."'>
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_elearning a JOIN rb_kategori_elearning b ON a.id_kategori_elearning=b.id_kategori_elearning where kodejdwl='".$_GET['jdwl']."' ORDER BY a.id_elearning");
                    while($r=mysqli_fetch_array($tampil)){
                      echo "<tr>
                              <td>$no</td>
                      ...
                      if (isset($_GET['hapus'])){
                        mysqli_query(dblink(), "DELETE FROM rb_elearning where id_elearning='".$_GET['hapus']."'");
...
if (isset($_POST['tambah'])){
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['c']['tmp_name'], $uploadfile)) {
          mysqli_query(dblink(), "INSERT INTO rb_elearning VALUES ('','".$_POST['a']."','".$_GET['jdwl']."','".$_POST['b']."','$filenamee','".$_POST['d']."','".$_POST['e']."','".$_POST['f']."')");
            echo "<script>document.location='index.php?view=bahantugas&act=listbahantugas&jdwl=".$_GET['jdwl']."&id=".$_GET['id']."&kd=".$_GET['kd']."';</script>";
        }else{
        ...
        mysqli_query(dblink(), "INSERT INTO rb_elearning VALUES ('','".$_POST['a']."','".$_GET['jdwl']."','".$_POST['b']."','','".$_POST['d']."','".$_POST['e']."','".$_POST['f']."')");
        echo "<script>document.location='index.php?view=bahantugas&act=listbahantugas&jdwl=".$_GET['jdwl']."&id=".$_GET['id']."&kd=".$_GET['kd']."';</script>";
      }
  }
                  ...
                  <tbody>
                    <tr><th width='120px' scope='row'>Kategori</th> <td><select class='form-control' name='a'> 
                             <option value='0' selected>- Pilih Kategori Tugas -</option>"; 
                              $kategori = mysqli_query(dblink(), "SELECT * FROM rb_kategori_elearning");
...
if (isset($_POST['update'])){
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['c']['tmp_name'], $uploadfile)) {
          mysqli_query(dblink(), "UPDATE rb_elearning SET id_kategori_elearning = '".$_POST['a']."',
                                               kodejdwl              = '".$_GET['jdwl']."',
                                               nama_file             = '".$_POST['b']."',
...
$edit = mysqli_query(dblink(), "SELECT * FROM rb_elearning a JOIN rb_kategori_elearning b ON a.id_kategori_elearning=b.id_kategori_elearning where a.id_elearning='".$_GET['edit']."'");
...
cek_session_siswa();
$cek = mysqli_fetch_array(mysqli_query(dblink(), "SELECT count(*) as total FROM rb_elearning_jawab where id_elearning='".$_GET['ide']."' AND nisn='".$iden['nisn']."'"));
  if ($cek['total'] >= 1){
    ...
    if (isset($_POST['kirimkan'])){
          ...
          if ($filename != ''){    
            ...
            if (move_uploaded_file($_FILES['c']['tmp_name'], $uploadfile)) {
              mysqli_query(dblink(), "INSERT INTO rb_elearning_jawab VALUES ('','".$_GET['ide']."','".$iden['nisn']."','".$_POST['a']."','".$filenamee."','".$waktuu."')");
                echo "<script>document.location='index.php?view=bahantugas&act=listbahantugas&jdwl=".$_GET['jdwl']."&id=".$_GET['id']."&kd=".$_GET['kd']."';</script>";
            }else{
     ...
     echo "<div class='col-xs-12'>  
              <div class='box'>
                ...
                <table class='table table-bordered table-striped'>
                    ...
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_elearning_jawab a JOIN rb_siswa b ON a.nisn=b.nisn ORDER BY a.id_elearning_jawab DESC");
                    $no = 1;
                    while($r=mysqli_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
                              <td>".$r['nisn']."</td>
...
cek_session_guru();
    $d = mysqli_fetch_array(mysqli_query(dblink(), "SELECT * FROM rb_kelas where kode_kelas='".$_GET['id']."'"));
    $m = mysqli_fetch_array(mysqli_query(dblink(), "SELECT * FROM rb_mata_pelajaran where kode_pelajaran='".$_GET['kd']."'"));
    $t = mysqli_fetch_array(mysqli_query(dblink(), "SELECT * FROM rb_elearning where id_elearning='".$_GET['ide']."'"));
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>List Upload Bahan dan Tugas</b></h3>
              ...
              <input type='hidden' name='pelajaran' value='".$_GET['kd']."'>
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_elearning_jawab a JOIN rb_siswa b ON a.nisn=b.nisn where a.id_elearning='".$_GET['ide']."' ORDER BY a.id_elearning_jawab DESC");
                    while($r=mysqli_fetch_array($tampil)){
                      echo "<tr>
                              <td>$no</td>
