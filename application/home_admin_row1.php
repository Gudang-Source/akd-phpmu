            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <?php $siswa = mysqli_fetch_array(mysqli_query(dblink(), "SELECT count(*) as total FROM rb_siswa")); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                <?php $guru = mysqli_fetch_array(mysqli_query(dblink(), "SELECT count(*) as total FROM rb_guru")); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                <?php $upload = mysqli_fetch_array(mysqli_query(dblink(), "SELECT count(*) as total FROM rb_elearning")); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                <?php $forum = mysqli_fetch_array(mysqli_query(dblink(), "SELECT count(*) as total FROM rb_forum_topic")); ?>
