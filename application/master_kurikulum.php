              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_kurikulum ORDER BY kode_kurikulum DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET['hapus'])){
                          mysqli_query(dblink(), "DELETE FROM rb_kurikulum where kode_kurikulum='".$_GET['hapus']."'");
...
<?php 
    ...
    if (isset($_POST['update'])){
        mysqli_query(dblink(), "UPDATE rb_kurikulum SET nama_kurikulum = '".$_POST['a']."',
                                         status_kurikulum = '".$_POST['b']."' where kode_kurikulum='".$_POST['id']."'");
      echo "<script>document.location='index.php?view=kurikulum';</script>";
    }
    $edit = mysqli_query(dblink(), "SELECT * FROM rb_kurikulum where kode_kurikulum='".$_GET['id']."'");
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=kurikulum' type='button' class='btn btn-default pull-right'>Cancel</a>
    ...
    if (isset($_POST['tambah'])){
        mysqli_query(dblink(), "INSERT INTO rb_kurikulum VALUES('','".$_POST['a']."','".$_POST['b']."')");
        echo "<script>document.location='index.php?view=kurikulum';</script>";
    }
