              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_status_kepegawaian ORDER BY id_status_kepegawaian DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET['hapus'])){
                          mysqli_query(dblink(), "DELETE FROM rb_status_kepegawaian where id_status_kepegawaian='".$_GET['hapus']."'");
...
<?php 
    ...
    if (isset($_POST['update'])){
        mysqli_query(dblink(), "UPDATE rb_status_kepegawaian SET status_kepegawaian = '".$_POST['a']."',
                                                      keterangan = '".$_POST['b']."' where id_status_kepegawaian='".$_POST['id']."'");
      echo "<script>document.location='index.php?view=statuspegawai';</script>";
    }
    $edit = mysqli_query(dblink(), "SELECT * FROM rb_status_kepegawaian where id_status_kepegawaian='".$_GET['id']."'");
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=statuspegawai' type='button' class='btn btn-default pull-right'>Cancel</a>
    ...
    if (isset($_POST['tambah'])){
        mysqli_query(dblink(), "INSERT INTO rb_status_kepegawaian VALUES('','".$_POST['a']."','".$_POST['b']."')");
        echo "<script>document.location='index.php?view=statuspegawai';</script>";
    }
