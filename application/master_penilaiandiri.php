...
<?php 
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=penilaiandiri' class='btn btn-default pull-right'>Cancel</a>
    ...
    if (isset($_POST['tambah'])){
        mysqli_query(dblink(), "INSERT INTO rb_pertanyaan_penilaian VALUES('','".$_POST['a']."','diri','".date('Y-m-d H:i:s')."')");
        echo "<script>document.location='index.php?view=penilaiandiri';</script>";
    }
