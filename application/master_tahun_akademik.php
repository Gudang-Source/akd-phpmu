              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_tahun_akademik ORDER BY id_tahun_akademik DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET['hapus'])){
                          mysqli_query(dblink(), "DELETE FROM rb_tahun_akademik where id_tahun_akademik='".$_GET['hapus']."'");
...
<?php 
    ...
    if (isset($_POST['update'])){
        mysqli_query(dblink(), "UPDATE rb_tahun_akademik SET id_tahun_akademik = '".$_POST['a']."',
                                         nama_tahun = '".$_POST['b']."',
                                         keterangan = '".$_POST['c']."',
                                         aktif = '".$_POST['d']."' where id_tahun_akademik='".$_POST['id']."'");
      echo "<script>document.location='index.php?view=tahunakademik';</script>";
    }
    $edit = mysqli_query(dblink(), "SELECT * FROM rb_tahun_akademik where id_tahun_akademik='".$_GET['id']."'");
    ...
    if (isset($_POST['tambah'])){
        mysqli_query(dblink(), "INSERT INTO rb_tahun_akademik VALUES('".$_POST['a']."','".$_POST['b']."','".$_POST['c']."','".$_POST['d']."')");
        echo "<script>document.location='index.php?view=tahunakademik';</script>";
    }
