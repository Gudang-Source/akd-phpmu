              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_jenis_ptk ORDER BY id_jenis_ptk DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET['hapus'])){
                          mysqli_query(dblink(), "DELETE FROM rb_jenis_ptk where id_jenis_ptk='".$_GET['hapus']."'");
...
<?php 
    ...
    if (isset($_POST['update'])){
        mysqli_query(dblink(), "UPDATE rb_jenis_ptk SET id_jenis_ptk = '".$_POST['a']."',
                                         keterangan = '".$_POST['b']."' where id_jenis_ptk='".$_POST['id']."'");
      echo "<script>document.location='index.php?view=ptk';</script>";
    }
    $edit = mysqli_query(dblink(), "SELECT * FROM rb_jenis_ptk where id_jenis_ptk='".$_GET['id']."'");
    ...
    if (isset($_POST['tambah'])){
        mysqli_query(dblink(), "INSERT INTO rb_jenis_ptk VALUES('','".$_POST['a']."','".$_POST['b']."')");
        echo "<script>document.location='index.php?view=ptk';</script>";
    }
