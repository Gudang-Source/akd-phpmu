              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query(dblink(), "SELECT * FROM rb_golongan ORDER BY id_golongan DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET['hapus'])){
                          mysqli_query(dblink(), "DELETE FROM rb_golongan where id_golongan='".$_GET['hapus']."'");
...
<?php 
    ...
    if (isset($_POST['update'])){
        mysqli_query(dblink(), "UPDATE rb_golongan SET id_golongan = '".$_POST['a']."',
                                         keterangan = '".$_POST['b']."' where id_golongan='".$_POST['id']."'");
      echo "<script>document.location='index.php?view=golongan';</script>";
    }
    $edit = mysqli_query(dblink(), "SELECT * FROM rb_golongan where id_golongan='".$_GET['id']."'");
    ...
    if (isset($_POST['tambah'])){
        mysqli_query(dblink(), "INSERT INTO rb_golongan VALUES('','".$_POST['a']."','".$_POST['b']."')");
        echo "<script>document.location='index.php?view=golongan';</script>";
    }
